			...
			<div id="main">
				...
				<!-- Three -->
					 <section id="three">
						...
						<p>Usted lo imagina, nosotros lo creamos</p>
						<div class="row">
							<div class="8u 12u$(small)">
								<form action="guardar.php" method="POST" enctype="multipart/form-data">
									<div class="row uniform 50%">
										...
										<div class="6u$ 12u$(xsmall)"><input type="text" name="city" id="city" placeholder="Ciudad" required/></div>
										<ul class="actions">
										<li><input type="submit" name="guardar" value="Enviar mensaje"class="button special" style="whidth:100%;"/></li>
										</ul>
									</div>
								</form>
